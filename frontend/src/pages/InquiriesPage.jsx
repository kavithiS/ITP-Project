...
const InquiriesPage = () => {
  ...
  // Add a new function to handle project creation
  const handleCreateProject = (e, inquiry) => {
    e.stopPropagation();
    // Add your create project logic here
    alert(`Creating project for ${inquiry.name}'s inquiry about ${inquiry.packageType}`);
  };
              ...
              {inquiries.map((inquiry) => (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="mt-5 pt-3 border-t border-[#FFEDED]">
                      <button 
                        className="w-full bg-[#FF0000] hover:bg-[#D10000] text-white py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center shadow-sm"
                        onClick={(e) => handleCreateProject(e, inquiry)}
                      >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-[#FFEDED]">
            ...
            <div className="p-6">
              ...
              <div className="mt-4 pt-4 border-t border-[#FFEDED]">
                <button
                  onClick={(e) => {
                    handleCreateProject(e, selectedInquiry);
                    closeInquiryDetails();
                  }}
                  className="w-full bg-[#FF0000] hover:bg-[#D10000] text-white py-3 rounded-md text-sm font-medium transition-colors flex items-center justify-center shadow-sm"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
